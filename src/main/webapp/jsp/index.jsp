...
<div class="container text-center" style="margin: auto;height:640px;background:url(${pageContext.request.contextPath}/img/login.jpg);width: 100%;background-size: cover">
