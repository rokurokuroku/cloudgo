...
public interface SellerController {
    ...
    String processRegister(String sellerName,String sellerEmail,String sellerTelephone,String sellerPassword,String reSellerPassword);
    /*数据库Sellers表生成一个新的对象
    ...
    String processChange(long userID,String userEmail,String userTelephone,char userGender,String address,String descriptions);
    /*修改用户信息
